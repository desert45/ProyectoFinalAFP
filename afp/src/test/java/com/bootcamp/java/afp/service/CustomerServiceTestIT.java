...
import com.bootcamp.java.afp.mapper.PensionFundMapper;
import com.bootcamp.java.afp.model.CustomersModel;
import com.bootcamp.java.afp.model.PensionFundModel;
...
class CustomerServiceTestIT {
	...
	@Spy
	private PensionFundMapper pensionFundMapper = Mappers.getMapper(PensionFundMapper.class);
